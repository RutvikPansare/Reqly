...
- [x] **T-253** UI component audit (React `src/ui/`): 5 logic/crash bugs fixed
  ...
  - Audited clean: `VariableInput`, `useWorkspaceTabs`, `useLocalStorage`, `useServerEvents`, `GraphQLSubscriptionStream` (lazy-close covers the missing explicit dispose). Verified: UI builds, full suite 1029 green, MCP e2e 17/17, 9/9 network-independent UI journeys.
