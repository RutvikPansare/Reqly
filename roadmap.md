...
- [ ] need to give per collection varibales as well along with thecurrent env variabes, i think collectio varibale should hol precedecne if there iare matching variables in both places, we will need to build a variable resolver for this purpose which should be bulletproof
