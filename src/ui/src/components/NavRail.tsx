import { Folder, Globe, History, Network, GitBranch, Radio, TerminalSquare, Settings } from 'lucide-react';

export type NavPanel = 'collections' | 'environments' | 'history' | 'graphql' | 'flows' | 'capture' | 'terminal' | 'settings';
