import { Folder, Globe, History, Network, GitBranch, Radio, Settings } from 'lucide-react';

export type NavPanel = 'collections' | 'environments' | 'history' | 'graphql' | 'flows' | 'capture' | 'settings';
